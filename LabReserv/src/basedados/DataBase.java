...
public class DataBase {
	...
	public static List<Laboratorio> obterTodosLaboratorios(){
		try{			
			return new ArrayList<Laboratorio>(laboratoriosCadastrados.values()) ;
		}catch (Exception e) {
			e.printStackTrace();
			return null;
		}
	...
	public static Integer atualizarReserva (Reserva reserva){
		try{			
			if (reservasCadastradas.containsKey(reserva.getCodReserva())){
				reservasCadastradas.remove(reserva.getCodReserva());
				reservasCadastradas.put(reserva.getCodReserva(), reserva);
